        ...
        <div class="login-screen">
          ...
          <div class="login-form">
            ...
            <div class="form-group">
                <center style="color:black">考勤创建于<?php echo ($daee); ?></center>
                <?php if($namee!=''): ?><center style="color:black">姓名：<?php echo ($namee); ?></center>
              <input type='hidden' name='name' id="login-name" value="<?php echo ($namee); ?>"/>
              <?php else: ?><input class="form-control login-field" placeholder="输入您的姓名(简体)" id="login-name" type="text" name='name' ><?php endif; ?>
              <label class="login-field-icon fui-user" for="login-name"></label>
              <p class="top15 captcha" id="captcha-container">  
</p>  
<input type='hidden' name='item' value="<?php echo I('item');?>"/>
            </div>
            
            <button class="btn btn-primary btn-lg btn-block" href="#">签      到</button>
            <a class="login-link" href="#" onclick="a()"></a>
